        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-sm">
              ...
              <div className="w-full h-8 bg-gray-800 rounded-t-3xl shadow-md border-b-4 border-gray-950 relative z-20 flex items-center justify-center">
              ...
              <motion.div
                ...
                className="bg-white border-x border-b border-gray-200 p-6 shadow-xl relative z-10 origin-top overflow-hidden"
                style={{ backgroundImage: 'radial-gradient(circle, #fff 95%, #e2e8f0 100%)', backgroundSize: '100% 6px', backgroundPosition: 'bottom' }}
              >
                ...
                <div className="space-y-4 font-mono text-xs text-gray-800">
                  <div className="text-center border-b border-dashed border-gray-200 pb-4">
                    <h3 className="font-black text-sm tracking-widest text-black">TASCKI RECEIPT</h3>
                    <p className="text-[10px] text-gray-500 font-bold">DATE: 2026-06-13 • TIME: 18:54</p>
                  </div>
                  ...
                  <div className="space-y-2 font-bold">
                    ...
                    <div className="flex justify-between">
                      <span>PEAK DEMAND MULTIPLIER</span>
                      <span>1.0x</span>
                    </div>
                  </div>

                  <div className="border-t border-dashed border-gray-200 pt-4 flex justify-between items-baseline font-black text-sm text-black">
                    <span>TOTAL CHARGE</span>
                    <span className="text-lg text-tascki-yellow font-black bg-black px-2 py-0.5 rounded">₹134.00</span>
                  </div>

                  <div className="border-t border-dashed border-gray-200 pt-4 text-center text-[9px] text-gray-500 font-bold leading-tight uppercase">
          ...
          <div className="lg:col-span-7 space-y-4">
            <h3 className="text-2xl font-black text-gray-900 mb-6 tracking-wide uppercase">Select Preferred Wallet</h3>
              ...
              {paymentMethods.map((method) => {
                ...
                return (
                  <motion.div
                    ...
                    whileTap={{ scale: 0.99 }}
                    className={`p-5 rounded-2xl cursor-pointer flex items-center justify-between transition-all duration-300 relative overflow-hidden ${
                      isSelected
                        ? 'bg-black text-white shadow-xl shadow-black/10 border-l-8 border-tascki-yellow'
                        : 'bg-white hover:bg-gray-50 text-gray-800 border border-gray-100'
                    }`}
                  >
                    <div className="flex items-center gap-4 relative z-10">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${
                        isSelected ? 'bg-tascki-yellow text-black' : 'bg-gray-50 text-gray-900 border border-gray-100'
                      }`}>
                        <method.icon size={24} className="stroke-[2.5]" />
                      </div>
                      <div>
                        <h4 className="font-extrabold text-base tracking-wide">{method.title}</h4>
                        <p className={`text-xs font-semibold leading-relaxed ${isSelected ? 'text-gray-400' : 'text-gray-500'}`}>
                          {method.desc}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative z-10 shrink-0">
                      {isSelected ? (
                        <div className="w-6 h-6 rounded-full bg-tascki-yellow text-black flex items-center justify-center">
